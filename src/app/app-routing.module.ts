...
export const routes: Routes = [
    ...
    {path: 'deviceDetails',component:AllDeviceDetailsComponent, canActivate: [authGuard]},
...
//-----------------------------------------------------------------------------------
//RFID Tags
    {path:'all-tags',component:AllTagsComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'create-tag',component:CreateTagComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'update-tag/:tagid',component:UpdateTagComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'Existing-Tags',component:ExistingTagsComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'Missing-Tags',component:MissingtagsComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'RFIDGate',component:RFIDGateCurrentComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'RFIDGateReport',component:RFIDGateReportComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'RFIDRegister',component:RFIDRegisterComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'tag_area/:name',component:ReaderComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'status',component:TagStatusComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'newTag',component:TagNewComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'Inuse',component:TagInuseComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
    {path:'lastlocation/:name',component:TagLastlocationComponent,canActivate: [roleGuard], data: { expectedRole: 'ADMIN' }},
